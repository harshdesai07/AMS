...
export default function FacultyRegistration() {
  ...
  useEffect(() => {
    const initForm = async () => {
      console.log("Initializing form with faculty data:", facultyData);
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(e.target.value, "facultyName")
                    }
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange(e.target.value, "facultyEmail")
                    }
                    className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none"
                ...
                <div className="relative">
                  ...
                  >
                    {designationOptions.map((option) => (
                      <option
                        key={`designation-${option.value || "default"}`}
                        value={option.value}
                      >
                        {option.label}
                      </option>
