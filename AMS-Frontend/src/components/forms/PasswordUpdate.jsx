...
import { Eye, EyeOff, Lock, Shield, Check, Loader2, AlertTriangle, ArrowRight, Key } from 'lucide-react';
...
const PasswordUpdate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (userRole === 'COLLEGE') {
        id = localStorage.getItem('collegeId');
        token = localStorage.getItem('collegeToken');
      }
