...
export default function FacultyTaskScheduler() {
  ...
  const collegeId = isHOD ? localStorage.getItem('hodCollegeId') : localStorage.getItem('facultyCollegeId');
  const token = isHOD ? localStorage.getItem('hodToken') : localStorage.getItem('facultyToken');
  const userId = isHOD ? localStorage.getItem('hodId') : localStorage.getItem('facultyId');
