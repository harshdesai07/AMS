...
const AttendanceManagement = () => {
    ...
    const userDepartment = localStorage.getItem('facultyDepartment');
    const departmentName = localStorage.getItem('facultyDepartment');
    const course = localStorage.getItem('facultyCourse');
    const collegeId = localStorage.getItem('facultyCollegeId');
